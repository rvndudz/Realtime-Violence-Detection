...
FRAME_FREQUENCY = 0.4  # Time interval (in seconds) between frames

FRAME_WIDTH = 224  # Width of frames for processing
FRAME_HEIGHT = 224  # Height of frames for processing
...
def annotate_frame(frame, probability_threshold):
    ...
    # Display a text annotation on the frame if the probability threshold is high
...
if __name__ == "__main__":
    ...
    if option == "1":
        input_video_path = '1.mp4'  # Provide the path to the video file you want to analyze
